...
{
    /// <summary>
    ///     Writes contents of a decimal field.
    /// </summary>
    [Service(Name = SystemFieldTypeConstants.Decimal)]
    internal class DecimalFieldFormatter : FieldFormatter
    {
        /// <summary>
        ...
        public override string Format(IFieldDefinition fieldDefinition, object item, FieldFormatArgs args)
        {
            ...
            var value = ((decimal)item).ToString(args.Format, args.Culture ?? CultureInfo.InvariantCulture);
